...
export const CHAT_DAILY_LIMIT_PREMIUM = parseInt(
  process.env.CHAT_DAILY_LIMIT_PREMIUM || "500",
  10
);
export const AUDIO_DAILY_LIMIT_PREMIUM = parseInt(
  process.env.AUDIO_DAILY_LIMIT_PREMIUM || "100",
  10
);
