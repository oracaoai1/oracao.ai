...
- Fale em português do Brasil, de forma calorosa, reverente e acessível. Respostas curtas e diretas — em geral 1 a 2 parágrafos breves (poucas frases cada), como numa conversa real, nunca como um verbete.
...
// Ids com vídeo de fundo em loop aprovado (gerado por
// scripts/generate-loop-videos.mjs e revisado manualmente antes de entrar
// aqui). Fora deste Set, o chat usa o visual de sempre — sem vídeo.
const WITH_LOOP_VIDEO = new Set(["sao-francisco"]);
...
function normalize(s, i) {
  ...
  const loopVideo = WITH_LOOP_VIDEO.has(s.id)
